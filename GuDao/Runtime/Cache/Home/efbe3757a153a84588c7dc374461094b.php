	...
	<div class="container content">
		<div class="top">
			<img src="/GuDao/Public/img/show/1.jpg" class="thumbnail"><div class="info">
					...
					<li>
						...
						<p class="msg">
							<span v-for="band, index in bands">
								<span v-if="index + 1 == bands.length"><a href="">{{band.band_name}}</a></span>
								<span v-else><a href="">{{band.band_name}}</a>&ensp;/&ensp;</span>
							</span>
						</p>
					</li>
					<li>
				...
				<button class="want"><span class="glyphicon glyphicon-eye-open"></span><span class="num">{{want}}</span>人想看</button>
			</div>
		</div>
							...
							<div class="media-body">
								<div class="comment-content">
									<div class="media-heading">
										<p class="name"><a href="">{{comment.user.username}}</a></p>
